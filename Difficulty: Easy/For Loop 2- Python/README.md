<h2><a href="https://www.geeksforgeeks.org/problems/for-loop-2-python/1?page=1&category=python&difficulty=Easy&sortBy=submissions">For Loop 2- Python</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given a <strong>string s</strong>, you need to print its characters at even indices(index starts at 0).</span></p>
