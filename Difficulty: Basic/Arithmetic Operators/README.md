<h2><a href="https://www.geeksforgeeks.org/problems/arithmetic-operators-1605594922/1?page=1&category=CPP&status=unsolved,attempted&sortBy=submissions">Arithmetic Operators</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given two integer variables <strong>x</strong> and <strong>y</strong>. You need to perform the following operations:</span></p>
<ul>
