<h2><a href="https://www.geeksforgeeks.org/problems/array-insert-at-end/1?page=1&category=Arrays&difficulty=Basic&sortBy=accuracy">Array End Insert</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p data-pm-slice="0 0 []"><span style="font-size: 14pt;">Given an array <strong>arr</strong> that is not completely filled and a value <strong>val</strong>, you have to insert the value at the <strong>end</strong> of the array.</span></p>
